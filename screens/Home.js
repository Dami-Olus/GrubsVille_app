...
function Home({navigation}) {
   ...
   const initialCurrentLocation = {
    streetName: "Olaiya Oladeji",
    gps: {
        latitude: 6.638491504018601,
        longitude: 3.386298197239977,
    }
}
  ...
  function renderMainCategories() {
    ...
    return (
      <View style={{ padding: SIZES.padding * 2 }}>
          <Text style={{ ...FONTS.h1 }}>Grubs</Text>
          <Text style={{ ...FONTS.h1 }}>Ville</Text>
